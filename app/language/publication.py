...
def publish_root_candidate(
    ...
    *,
    ...
    The caller owns the transaction.  No commit occurs here; this lets the
    candidate state, language authority, version and audit record share the
