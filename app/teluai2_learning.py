...
def prompt_context(user_id: int, role: str = "user", message: str = "") -> str:
    ...
    if terms:
        ...
        lines.append("ముఖ్యమైన పద వినియోగ నియమం: ప్రస్తుత సందేశంలోని పదం నేర్చుకున్న పదానికి రూపాంతరం అయితే, ఆ నేర్చుకున్న సంబంధాన్ని సమాధానంలో ఉపయోగించాలి. ఈ సందర్భంలో జోకులు, వినోదం లేదా సంబంధం లేని ప్రత్యామ్నాయ అర్థాన్ని ఎంచుకోకూడదు.")
